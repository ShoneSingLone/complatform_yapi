...
// const modelWiki = require('../xspace-plugin-wiki/modelWiki.js');
...
class exportController extends ControllerBase {
	...
	async exportData(ctx, fullPath) {
		...
		if (!pid) {
			return (ctx.body = xU.$response(null, 200, "pid 不为空"));
		}
		...
		try {
			...
			if (isWiki === "true") {
				const modelWiki = require("../xspace-plugin-wiki/modelWiki");
      ...
      <body>
        <div class="m-header">
          ...
          <a href="#"><h1 class="title">xspace 接口文档</h1></a>
          <div class="nav">
            <a href="https://hellosean1025.github.io/xspace/">xspace</a>
          </div>
        </div>
        <div class="g-doc">
          ${left}
