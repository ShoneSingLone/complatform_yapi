...
asyncGetLocalRepoBranchInfo:Function;
SSE_TYPE:object;
SSE_TYPE_HANDLERS:object;
setSseStream:Function;
removeSseStream:Function;
sseOn:Function;
sseOff:Function;
sseTrigger:Function;
...
*/
								...
								menu:  (parems:{belong_type?:string,belong_id?:string,select?:string})=>Promise<any> ;
