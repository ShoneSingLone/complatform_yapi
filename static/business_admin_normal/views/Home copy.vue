	...
	<div class="x-page-view">
		<xPageContent>
			<div class="app-container home">
				...
				<xRow :gutter="20">
					<xCol :sm="24" :lg="12" style="padding-left: 20px">
						<h2>若依后台管理框架</h2>
						<p>
					...
					<xCol :sm="24" :lg="12" style="padding-left: 50px">
						<xRow>
							<xCol :span="12">
								<h2>技术选型</h2>
							</xCol>
				...
				<xDivider />
				<xRow :gutter="20">
					<xCol :xs="24" :sm="24" :md="12" :lg="8">
						<xCard class="update-log">
					...
					<xCol :xs="24" :sm="24" :md="12" :lg="8">
						<xCard class="update-log">
							...
							<xCollapse accordion>
								<xCollapse-item title="v3.8.7 - 2023-12-08">
									<ol>
										<li>操作日志记录部门名称</li>
										<li>全局数据存储用户编号</li>
										<li>新增编程式判断资源访问权限</li>
								...
								<xCollapse-item title="v3.8.6 - 2023-06-30">
									<ol>
										<li>支持登录IP黑名单限制</li>
										<li>新增监控页面图标显示</li>
										<li>操作日志新增消耗时间属性</li>
								...
								<xCollapse-item title="v3.8.5 - 2023-01-01">
									<ol>
										<li>定时任务违规的字符</li>
										<li>重置时取消部门选中</li>
										<li>新增返回警告消息提示</li>
								...
								<xCollapse-item title="v3.8.4 - 2022-09-26">
									<ol>
										<li>数据逻辑删除不进行唯一验证</li>
								...
								<xCollapse-item title="v3.8.3 - 2022-06-27">
									<ol>
										<li>新增缓存列表菜单功能</li>
								...
								<xCollapse-item title="v3.8.2 - 2022-04-01">
									<ol>
								...
								<xCollapse-item title="v3.8.1 - 2022-01-01">
									<ol>
								...
								<xCollapse-item title="v3.8.0 - 2021-12-01">
									<ol>
								...
								<xCollapse-item title="v3.7.0 - 2021-09-13">
									<ol>
										<li>参数管理支持配置验证码开关</li>
										<li>新增是否开启用户注册功能</li>
								...
								<xCollapse-item title="v3.6.0 - 2021-07-12">
									<ol>
										<li>角色管理新增分配用户功能</li>
										<li>用户管理新增分配角色功能</li>
										<li>日志列表支持排序操作</li>
								...
								<xCollapse-item title="v3.4.0 - 2021-02-22">
									<ol>
										<li>代码生成模板支持主子表</li>
								...
								<xCollapse-item title="v3.3.0 - 2020-12-14">
									<ol>
										<li>新增缓存监控功能</li>
										<li>支持主题风格配置</li>
								...
								<xCollapse-item title="v3.2.1 - 2020-11-18">
									<ol>
										<li>阻止任意文件下载漏洞</li>
										<li>代码生成支持上传控件</li>
										<li>新增图片上传组件</li>
								...
								<xCollapse-item title="v3.2.0 - 2020-10-10">
									<ol>
								...
								<xCollapse-item title="v3.1.0 - 2020-08-13">
									<ol>
								...
								<xCollapse-item title="v3.0.0 - 2020-07-20">
									<ol>
										<li>单应用调整为多模块项目</li>
								...
								<xCollapse-item title="v2.3.0 - 2020-06-01">
									<ol>
								...
								<xCollapse-item title="v2.2.0 - 2020-03-18">
									<ol>
										<li>系统监控新增定时任务功能</li>
								...
								<xCollapse-item title="v2.1.0 - 2020-02-24">
									<ol>
										<li>新增表单构建</li>
										<li>代码生成支持树表结构</li>
										<li>新增用户导入</li>
								...
								<xCollapse-item title="v2.0.0 - 2019-12-02">
									<ol>
										<li>新增代码生成</li>
								...
								<xCollapse-item title="v1.1.0 - 2019-11-11">
									<ol>
										<li>新增在线用户管理</li>
								...
								<xCollapse-item title="v1.0.0 - 2019-10-08">
									<ol>
										<li>若依前后端分离系统正式发布</li>
									</ol>
								</xCollapse-item>
