...
(function () {
		...
		const setTransition = function (duration) {
			...
			elements.forEach(parallaxEl => {
				let parallaxDuration =
					parseInt(parallaxEl.getAttribute("data-swiper-parallax-duration"), 10) ||
					duration;
	...
	function A11y(_ref) {
		...
		const init = () => {
			...
			const live =
				swiper.params.autoplay && swiper.params.autoplay.enabled ? "off" : "polite";
