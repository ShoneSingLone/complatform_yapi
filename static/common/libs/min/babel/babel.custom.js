(() => {
					...
					(a = g(r, a)) < n && (t = !1),
						...
						(e = V(r, u)
							? ((o = g(r, o)),
								(s = g(r, s)),
								(l = g(r, l)),
								V(r, u) ? ((p = g(r, p)), [a, o, s, l, p]) : [a, o, s, l])
							: [a]),
						c.push(e),
						r.pos++;
				}
				t || c.sort(X), i.push(c), (r.pos = u + 1);
			} while (r.pos <= t);
			return i;
		}),
			...
			(n.encodeGeneratedRanges = function (t) {
				...
				for (let e = 0; e < t.length; )
					e = (function r(i, a, o, s) {
						...
						s[0] < t ? (J(o, s[0], t), (s[0] = t), (s[1] = 0)) : 0 < a && o.write(m);
						s[1] = T(o, l[1], s[1]);
						...
						s[0] < u ? (J(o, s[0], u), (s[0] = u), (s[1] = 0)) : o.write(m);
						s[1] = T(o, c, s[1]);
						return a;
					})(t, e, n, [0, 0, 0, 0, 0, 0, 0]);
				return n.flush();
			...
			n.exports);
	{
		...
		function G(t, n) {
			...
			if (r !== t.length) {
				n || (t = t.slice());
				for (let e = r; e < t.length; e = z(t, e + 1))
					t[e] = ((e, t) => (e = t ? e : e.slice()).sort(H))(t[e], n);
			}
			return t;
		}
		function z(t, n) {
		...
		function re(e, r, i, a, o, s, l, p, u, c, d) {
			var f = e.sections;
			for (let n = 0; n < f.length; n++) {
				...
				n + 1 < f.length &&
					...
					!(function (e, t, n, r, i, a, o, s, l, p, u) {
						e = ne(e);
						if ("sections" in e) return re(...arguments);
						var e = new ql(e, t),
							c = r.length,
							d = a.length,
							f = oe(e),
							{ resolvedSources: y, sourcesContent: t, ignoreList: m } = e;
						if ((ie(r, y), ie(a, e.names), t)) ie(i, t);
		...
		class ql {
			constructor(e, t) {
				...
				let p = W(o || "", (r = t) ? ((i = r.lastIndexOf("/")), r.slice(0, i + 1)) : "");
				this.resolvedSources = s.map(e => W(e || "", p));
				a = e.mappings;
				"string" == typeof a
					? ((this._encoded = a), (this._decoded = void 0))
					: ((this._encoded = void 0), (this._decoded = G(a, n))),
					(this._decodedMemo = Z()),
		...
		function ae(e) {
			var t;
			return null != (t = e._encoded) ? t : (e._encoded = q.encode(e._decoded));
		}
		function oe(e) {
			return e._decoded || (e._decoded = q.decode(e._encoded));
		}
		function se(e, t) {
		...
		function fe(t, n, r, i, a, o) {
			...
			let e = s.indexOf(n);
			if (-1 === (e = -1 === e ? l.indexOf(n) : e)) return o ? [] : ce(null, null);
			l = (t._bySources ||
				(t._bySources = ((e, n) => {
					var r = n.map(te);
					...
					return r;
				})(oe(t), (t._bySourceMemos = s.map(Z)))))[e][r];
			if (null == l) return o ? [] : ce(null, null);
			n = t._bySourceMemos[e];
			if (o) {
				var p = l,
					s = i,
					t = a;
				let e = de(p, (o = n), r, s, b);
				if ((m || t !== S || e++, -1 === e || e === p.length)) return [];
				for (
					var o = m ? s : p[e][A], u = $(p, o, (e = m ? e : Q(p, o, e))), c = [];
					e <= u;
					e++
				) {
					var d = p[e];
			...
			return -1 === (t = de(l, n, r, i, a)) ? ce(null, null) : ce((s = l[t])[f] + 1, s[y]);
		}
		(t.AnyMap = function (e, t) {
			var n,
				r,
				i,
				a,
			...
			(t.GREATEST_LOWER_BOUND = b),
			(t.LEAST_UPPER_BOUND = S),
			(t.TraceMap = ql),
			(t.allGeneratedPositionsFor = function (e, t) {
				var { source: t, line: n, column: r, bias: i } = t;
				return fe(e, t, n, r, i || S, !0);
			}),
			(t.decodedMap = function (e) {
				return pe(e, oe(e));
			}),
			(t.decodedMappings = oe),
			(t.eachMapping = function (e, o) {
				var t = oe(e),
			...
			(t.encodedMap = function (e) {
				return pe(e, ae(e));
			}),
			(t.encodedMappings = ae),
			(t.generatedPositionFor = function (e, t) {
				var { source: t, line: n, column: r, bias: i } = t;
				return fe(e, t, n, r, i || b, !1);
			}),
			(t.isIgnored = function (e, t) {
				var n = e.ignoreList;
				return null != n && -1 !== (e = se(e, t)) && n.includes(e);
			}),
			(t.originalPositionFor = function (e, t) {
				var { line: t, column: n, bias: r } = t;
				if (--t < 0) throw new Error(T);
				if (n < 0) throw new Error(h);
				var i = oe(e);
				return t >= i.length ||
					-1 === (t = de((i = i[t]), e._decodedMemo, t, n, r || b)) ||
					1 === (n = i[t]).length
					? ue(null, null, null, null)
					: (({ names: r, resolvedSources: i } = e),
						ue(i[n[O]], n[_] + 1, n[I], 5 === n.length ? r[n[C]] : null));
			}),
			(t.presortedDecodedMap = le),
			(t.sourceContentFor = function (e, t) {
				var n = e.sourcesContent;
				return null == n || -1 === (e = se(e, t)) ? null : n[e];
			}),
			(t.traceSegment = function (e, t, n) {
				var r = oe(e);
				return t >= r.length || -1 === (e = de((r = r[t]), e._decodedMemo, t, n, b))
					? null
					: r[e];
			});
	}
	r = e.exports;
	{
		...
		class Ul {
			constructor({ file: e, sourceRoot: t } = {}) {
				(this._names = new ye.SetArray()),
					(this._sources = new ye.SetArray()),
					(this._sourcesContent = []),
					(this._mappings = []),
					(this.file = e),
					(this.sourceRoot = t),
					(this._ignoreList = new ye.SetArray());
			}
		}
		(t = (e, t, n, r, i, a, o, s) => Se(!0, e, t, n, r, i, a, o, s)),
			(F = (e, t) => ve(!0, e, t));
		function he(e) {
		...
		function Ee(t, n) {
			for (let e = 0; e < n.length; e++) ye.put(t, n[e]);
		}
		function ve(e, t, n) {
			var { generated: n, source: r, original: i, name: a, content: o } = n;
			return r
				? Se(e, t, n.line - 1, n.column, r, i.line - 1, i.column, a, o)
				: Se(e, t, n.line - 1, n.column, null, null, null, null, null);
		}
		(r.GenMapping = Ul),
			(r.addMapping = function (e, t) {
				return ve(!1, e, t);
			}),
			(r.addSegment = function (e, t, n, r, i, a, o, s) {
				return Se(!1, e, t, n, r, i, a, o, s);
			}),
			(r.allMappings = function (e) {
				var a = [],
			...
			(r.fromMap = function (e) {
				var e = new Te.TraceMap(e),
					t = new Ul({ file: e.file, sourceRoot: e.sourceRoot });
				return (
					Ee(t._names, e.names),
					Ee(t._sources, e.sources),
					(t._sourcesContent = e.sourcesContent || e.sources.map(() => null)),
					(t._mappings = Te.decodedMappings(e)),
					e.ignoreList && Ee(t._ignoreList, e.ignoreList),
					t
				);
			}),
			(r.maybeAddMapping = F),
			(r.maybeAddSegment = t),
			(r.setIgnore = function (e, t, n = !0) {
				var { _sources: e, _sourcesContent: r, _ignoreList: i } = e;
				(e = ye.put(e, t)) === r.length && (r[e] = null),
					n ? ye.put(i, e) : ye.remove(i, e);
			}),
			(r.setSourceContent = function (e, t, n) {
				var { _sources: e, _sourcesContent: r } = e;
				r[ye.put(e, t)] = n;
			}),
			(r.toDecodedMap = he),
			(r.toEncodedMap = function (e) {
				return (
					(e = he(e)),
					Object.assign(Object.assign({}, e), { mappings: me.encode(e.mappings) })
				);
			}),
		...
		t =
			((B.default = class {
				constructor(e, t) {
					...
					var n,
						r = (this._map = new ge.GenMapping({ sourceRoot: e.sourceRoot }));
					if (
						...
						this._inputMap = new Pe.TraceMap(e.inputSourceMap);
						var i,
							a = this._inputMap.resolvedSources;
						if (a.length)
							for (let e = 0; e < a.length; e++)
								(0, ge.setSourceContent)(
									r,
									a[e],
					...
					if ("string" != typeof t || e.inputSourceMap) {
						if ("object" == typeof t)
							for (var o of Object.keys(t))
								(0, ge.setSourceContent)(r, o.replace(/\\/g, "/"), t[o]);
					} else (0, ge.setSourceContent)(r, this._sourceFileName, t);
				}
				get() {
					return (0, ge.toEncodedMap)(this._map);
				}
				getDecoded() {
					return (0, ge.toDecodedMap)(this._map);
				}
				getRawMappings() {
					return (
						this._rawMappings || (this._rawMappings = (0, ge.allMappings)(this._map))
					);
				}
				mark(e, t, n, r, i, a) {
					this._rawMappings = void 0;
					...
					null != t &&
						(this._inputMap
							? !(o = (0, Pe.originalPositionFor)(this._inputMap, {
									line: t,
									column: n
								})).name &&
								i &&
								(i = (0, Pe.originalPositionFor)(this._inputMap, i)).name &&
								(r = i.name)
							: (o = {
									source:
						...
						(0, ge.maybeAddMapping)(this._map, {
							name: r,
							generated: e,
						...
						? ((r = this._fastIndentations[t]),
							(this._str +=
								void 0 !== r
									? r
									: 1 < t
										? this._indentChar.repeat(t)
										: this._indentChar))
						: (this._str +=
								1 < t ? String.fromCharCode(e).repeat(t) : String.fromCharCode(e)),
						10 !== e
							? (this._mark(
									n.line,
									n.column,
...
` +
	...
	Object.defineProperty(i, "__esModule", { value: !0 }),
		...
		(i.isBlockStatement = function (e, t) {
			return !!e && "BlockStatement" === e.type && (null == t || (0, a.default)(e, t));
		}),
		(i.isBooleanLiteral = function (e, t) {
			return !!e && "BooleanLiteral" === e.type && (null == t || (0, a.default)(e, t));
		}),
		(i.isBooleanLiteralTypeAnnotation = function (e, t) {
			return (
				!!e &&
		...
		(i.isDeclareClass = function (e, t) {
			return !!e && "DeclareClass" === e.type && (null == t || (0, a.default)(e, t));
		}),
		(i.isDeclareExportAllDeclaration = function (e, t) {
			return (
				!!e &&
		...
		(i.isExpressionStatement = function (e, t) {
			return !!e && "ExpressionStatement" === e.type && (null == t || (0, a.default)(e, t));
		}),
		(i.isExpressionWrapper = function (e, t) {
			if (!e) return !1;
			switch (e.type) {
		...
		(i.isFlowBaseAnnotation = function (e, t) {
			if (!e) return !1;
			switch (e.type) {
				case "AnyTypeAnnotation":
				case "BooleanTypeAnnotation":
		...
		(i.isFlowDeclaration = function (e, t) {
			if (!e) return !1;
			switch (e.type) {
				case "DeclareClass":
				case "DeclareFunction":
		...
		(i.isFlowPredicate = function (e, t) {
			if (!e) return !1;
			switch (e.type) {
				case "DeclaredPredicate":
				case "InferredPredicate":
		...
		(i.isLabeledStatement = function (e, t) {
			return !!e && "LabeledStatement" === e.type && (null == t || (0, a.default)(e, t));
		}),
		(i.isLiteral = function (e, t) {
			if (!e) return !1;
			switch (e.type) {
				case "StringLiteral":
				case "NumericLiteral":
		...
		(i.isMiscellaneous = function (e, t) {
			if (!e) return !1;
			switch (e.type) {
				case "Noop":
				case "Placeholder":
		...
		(i.isMixedTypeAnnotation = function (e, t) {
			return !!e && "MixedTypeAnnotation" === e.type && (null == t || (0, a.default)(e, t));
		}),
		(i.isModuleDeclaration = function (e, t) {
			return (0, Ce.default)("isModuleDeclaration", "isImportOrExportDeclaration"), De(e, t);
		}),
		(i.isModuleExpression = function (e, t) {
			return !!e && "ModuleExpression" === e.type && (null == t || (0, a.default)(e, t));
		}),
		(i.isModuleSpecifier = function (e, t) {
			if (!e) return !1;
			switch (e.type) {
		...
		(i.isPipelineBareFunction = function (e, t) {
			return !!e && "PipelineBareFunction" === e.type && (null == t || (0, a.default)(e, t));
		}),
		(i.isPipelinePrimaryTopicReference = function (e, t) {
			return (
				!!e &&
		...
		(i.isSequenceExpression = function (e, t) {
			return !!e && "SequenceExpression" === e.type && (null == t || (0, a.default)(e, t));
		}),
		(i.isSpreadElement = function (e, t) {
			return !!e && "SpreadElement" === e.type && (null == t || (0, a.default)(e, t));
		}),
		(i.isSpreadProperty = function (e, t) {
			return (
				(0, Ce.default)("isSpreadProperty", "isSpreadElement"),
				!!e && "SpreadProperty" === e.type && (null == t || (0, a.default)(e, t))
			);
		}),
		(i.isStandardized = function (e, t) {
			if (!e) return !1;
			switch (e.type) {
				case "ArrayExpression":
				case "AssignmentExpression":
		...
		(i.isStaticBlock = function (e, t) {
			return !!e && "StaticBlock" === e.type && (null == t || (0, a.default)(e, t));
		}),
		(i.isStringLiteral = function (e, t) {
			return !!e && "StringLiteral" === e.type && (null == t || (0, a.default)(e, t));
		}),
		(i.isStringLiteralTypeAnnotation = function (e, t) {
			return (
				!!e &&
		...
		(i.isTSConditionalType = function (e, t) {
			return !!e && "TSConditionalType" === e.type && (null == t || (0, a.default)(e, t));
		}),
		(i.isTSConstructSignatureDeclaration = function (e, t) {
			return (
				!!e &&
		...
		(i.isTSTypeParameterInstantiation = function (e, t) {
			return (
				!!e &&
	...
	Object.defineProperty(Ae, "__esModule", { value: !0 }),
		(Ae.default = function (e, t, n) {
			if (!(0, Ne.isMemberExpression)(e)) return !1;
			let r = Array.isArray(t) ? t : t.split("."),
				i = [],
				a;
			for (a = e; (0, Ne.isMemberExpression)(a); a = a.object) i.push(a.property);
			if ((i.push(a), i.length < r.length)) return !1;
			if (!n && i.length > r.length) return !1;
			for (let t = 0, n = i.length - 1; t < r.length; t++, n--) {
				var o = i[n];
				let e;
				if ((0, Ne.isIdentifier)(o)) e = o.name;
				else if ((0, Ne.isStringLiteral)(o)) e = o.value;
				else {
					if (!(0, Ne.isThisExpression)(o)) return !1;
					e = "this";
				}
				if (r[t] !== e) return !1;
			}
	...
	var Ne = i,
		we =
			...
			(xe.default = function (e, t) {
				let n = e.split(".");
				return e => (0, we.default)(e, n, t);
			}),
			Ae),
		je =
			(Object.defineProperty(n, "__esModule", { value: !0 }),
			((n.default = void 0), xe.default)("React.Component")),
		je = ((n.default = je), {}),
		ke =
		...
		Re =
			...
			(Fe.default = function (e, t) {
				if (e === t) return !0;
				if (null != e && !Re.ALIAS_KEYS[t]) {
					t = Re.FLIPPED_ALIAS_KEYS[t];
					if (t) {
						if (t[0] === e) return !0;
		...
		Ye =
			...
			(Ke.default = function (e, t) {
				if (e === t) return !0;
				e = Ye.PLACEHOLDERS_ALIAS[e];
		...
		Ve =
			...
			(Be.default = function (e, t, n) {
				if (!t) return !1;
				var r = (0, Je.default)(t.type, e);
				if (!r)
					return (
						!n &&
						"Placeholder" === t.type &&
						e in qe.FLIPPED_ALIAS_KEYS &&
						(0, Xe.default)(t.expectedNode, e)
					);
				return void 0 === n || (0, Ve.default)(t, n);
			}),
			Oe),
		Je = Fe,
		Xe = Ke,
			...
			(u.isIdentifierName = function (n) {
				...
				for (let t = 0; t < n.length; t++) {
					...
					if (
						...
						if (((r = !1), !Ze(e))) return !1;
					} else if (!et(e)) return !1;
				}
				return !r;
			}),
			(u.isIdentifierStart = Ze),
		...
		return e < 65
			...
			: e <= 90 ||
					(e < 97
						? 95 === e
						: e <= 122 ||
							(e <= 65535 ? 170 <= e && Ge.test(String.fromCharCode(e)) : Qe(e, He)));
	}
	function et(e) {
		return e < 48
			? 36 === e
					...
					(!(e < 65) &&
						(e <= 90 ||
							(e < 97
								...
								: e <= 122 ||
									(e <= 65535
										? 170 <= e && ze.test(String.fromCharCode(e))
										: Qe(e, He) || Qe(e, $e)))));
	}
	var tt,
		nt,
	...
	Object.defineProperty(c, "__esModule", { value: !0 }),
		...
		(c.isReservedWord = pt),
		(c.isStrictBindOnlyReservedWord = ct),
		(c.isStrictBindReservedWord = function (e, t) {
			return ut(e, t) || ct(e);
		}),
		(c.isStrictReservedWord = ut);
	const rt = [
			"break",
			"case",
			"catch",
	...
	(d = We),
		...
		Object.defineProperty(d, "isReservedWord", {
			enumerable: !0,
			get: function () {
				return nt.isReservedWord;
			}
		}),
		Object.defineProperty(d, "isStrictBindOnlyReservedWord", {
			enumerable: !0,
			get: function () {
				return nt.isStrictBindOnlyReservedWord;
			}
		}),
		Object.defineProperty(d, "isStrictBindReservedWord", {
			enumerable: !0,
			get: function () {
				return nt.isStrictBindReservedWord;
			}
		}),
		Object.defineProperty(d, "isStrictReservedWord", {
			enumerable: !0,
			get: function () {
				return nt.isStrictReservedWord;
			}
		}),
		(tt = u),
		(nt = c),
		Object.defineProperty(Ue, "__esModule", { value: !0 }),
		(Ue.default = function (e, t = !0) {
			if ("string" != typeof e) return !1;
			if (t && ((0, dt.isKeyword)(e) || (0, dt.isStrictReservedWord)(e, !0))) return !1;
			return (0, dt.isIdentifierName)(e);
		});
	var dt = We,
		d = {},
		ft =
							...
							null !==
								(f = ((n, r, i, a, o, s) => {
									...
									switch (p) {
										...
										case 120:
											return (
												({ code: e, pos: r } = Tt(n, r, i, a, 2, !1, t, s)),
												l(null === e ? null : String.fromCharCode(e))
											);
										case 117:
											return (
												({ code: e, pos: r } = St(n, r, i, a, t, s)),
	...
	function Tt(e, t, n, r, i, a, o, s) {
		var l = t;
		return (
			({ n: e, pos: t } = ht(e, t, n, r, 16, i, a, !1, s, !o)),
			null === e && (o ? s.invalidEscapeSequence(l, n, r) : (t = l - 1)),
			{ code: e, pos: t }
		);
	}
	function ht(n, r, i, a, o, s, l, p, u, c) {
		var e = r,
			d = 16 === o ? yt.hex : yt.decBinOct,
			f = 16 === o ? mt.hex : 10 === o ? mt.dec : 8 === o ? mt.oct : mt.bin;
		let y = !1,
			m = 0;
		for (let e = 0, t = null == s ? 1 / 0 : s; e < t; ++e) {
			...
			if (95 === T && "bail" !== p) {
				...
				if (
					(e = 97 <= T ? T - 97 + 10 : 65 <= T ? T - 65 + 10 : ft(T) ? T - 48 : 1 / 0) >=
					o
				) {
	...
	function St(e, t, n, r, i, a) {
		...
		if (123 === e.charCodeAt(t)) {
			if (
				(++t,
				({ code: o, pos: t } = Tt(e, t, n, r, e.indexOf("}", t) - t, !0, i, a)),
				++t,
				null !== o && 1114111 < o)
			) {
		...
		} else ({ code: o, pos: t } = Tt(e, t, n, r, 4, !1, i, a));
		return { code: o, pos: t };
	}
	var u = {},
		c =
		...
		bt =
			...
			(y.assertNodeOrValueType = function (...i) {
				function e(e, t, n) {
					for (var r of i)
						if (It(n) === r || (0, bt.default)(r, n))
							return void (0, Et.validateChild)(e, t, n);
					throw new TypeError(
			...
			(y.assertShape = function (a) {
				function e(e, t, n) {
					...
					for (r of Object.keys(a))
						try {
							(0, Et.validateField)(e, r, n[r], a[r]);
						} catch (e) {
...
` + i.join("\n")
			...
			(y.validateOptionalType = function (...e) {
				return { validate: jt(...e), optional: !0 };
			}),
			...
			Be),
		Et = Le;
	let vt = (y.VISITOR_KEYS = {}),
		gt = (y.ALIAS_KEYS = {}),
		Pt = (y.FLIPPED_ALIAS_KEYS = {}),
		xt = (y.NODE_FIELDS = {}),
		At = (y.BUILDER_KEYS = {}),
		Ot = (y.DEPRECATED_KEYS = {}),
		_t = (y.NODE_PARENT_VALIDATIONS = {});
	function It(e) {
	...
	function Dt(e) {
		return Lt(kt("array"), wt(e));
	}
	function Nt(...e) {
		return Dt(jt(...e));
	}
	function wt(o) {
		let s = {}.BABEL_TYPES_8_BREAKING ? Et.validateChild : () => {};
		function e(t, n, r) {
			if (Array.isArray(r))
	...
	function jt(...i) {
		function e(e, t, n) {
			for (var r of i) if ((0, bt.default)(r, n)) return void (0, Et.validateChild)(e, t, n);
			throw new TypeError(
				`Property ${t} of ${e.type} expected node to be of a type ${JSON.stringify(i)} but instead got ` +
					JSON.stringify(null == n ? void 0 : n.type)
			);
	...
	function kt(r) {
		function e(e, t, n) {
			if (!(It(n) === r))
				throw new TypeError(`Property ${t} expected type of ${r} but got ` + It(n));
		}
		return (e.type = r), e;
	}
	function Lt(...n) {
	...
	let Mt = new Set([
		...
		Bt = new Set(["default", "optional", "deprecated", "validate"]),
		Ft = {};
	function Rt(t, e = {}) {
		var n,
			r = (e.inherits && Ft[e.inherits]) || {};
		let i = e.fields;
		if (!i && ((i = {}), r.fields))
		...
		for (s of Object.keys(e))
			if (!Mt.has(s)) throw new Error(`Unknown type option "${s}" on ` + t);
		e.deprecatedAlias && (Ot[e.deprecatedAlias] = t);
		...
		for (p of Object.keys(i)) {
			...
			void 0 === y.default || d.includes(p) || (y.optional = !0),
				void 0 === y.default
					? (y.default = null)
					: y.validate || null == y.default || (y.validate = kt(It(y.default)));
			for (f of Object.keys(y))
				if (!Bt.has(f)) throw new Error(`Unknown field key "${f}" on ${t}.` + p);
		}
		(vt[t] = e.visitor = u),
			(At[t] = e.builder = d),
			(xt[t] = e.fields = i),
			(gt[t] = e.aliases = c).forEach(e => {
				(Pt[e] = Pt[e] || []), Pt[e].push(t);
			}),
			e.validate && (_t[t] = e.validate),
			(Ft[t] = e);
	}
	...
	var Kt = Be,
		...
		Xt = u,
		m = y;
	(f = (0, m.defineAliasedType)("Standardized"))("ArrayExpression", {
		fields: {
			elements: {
			...
			fields: {
				operator: {
					validate: {}.BABEL_TYPES_8_BREAKING
						? Object.assign(
								(() => {
									let r = (0, m.assertOneOf)(...Xt.ASSIGNMENT_OPERATORS),
										i = (0, m.assertOneOf)("=");
									return function (e, t, n) {
										((0, Kt.default)("Pattern", e.left) ? i : r)(e, t, n);
									};
								})(),
								{ type: "string" }
							)
		...
		f("BinaryExpression", {
			builder: ["operator", "left", "right"],
			fields: {
				operator: { validate: (0, m.assertOneOf)(...Xt.BINARY_OPERATORS) },
				left: {
					validate: (() => {
	...
	var c = () => ({
			...
			f("FunctionDeclaration", {
				...
				validate: {}.BABEL_TYPES_8_BREAKING
					? (() => {
							...
							return function (e, t, n) {
								(0, Kt.default)("ExportDefaultDeclaration", e) || r(n, "id", n.id);
							};
						})()
					: void 0
			}),
		...
		h =
					...
					? function (e, t, n) {
							...
							if (t) {
								var [, t] = t,
									r = { computed: !1 };
								if ("property" === t) {
									if ((0, Kt.default)("MemberExpression", e, r)) return;
									if ((0, Kt.default)("OptionalMemberExpression", e, r)) return;
								} else if ("key" === t) {
									if ((0, Kt.default)("Property", e, r)) return;
									if ((0, Kt.default)("Method", e, r)) return;
								} else if ("exported" === t) {
									if ((0, Kt.default)("ExportSpecifier", e)) return;
								} else if ("imported" === t) {
									if ((0, Kt.default)("ImportSpecifier", e, { imported: n }))
										return;
								} else if (
									"meta" === t &&
									(0, Kt.default)("MetaProperty", e, { meta: n })
								)
									return;
								if (
									((0, Vt.isKeyword)(n.name) ||
										(0, Vt.isReservedWord)(n.name, !1)) &&
									"this" !== n.name
								)
			...
			f("LogicalExpression", {
				...
				aliases: ["Binary", "Expression"],
				fields: {
					operator: { validate: (0, m.assertOneOf)(...Xt.LOGICAL_OPERATORS) },
									...
									Object.assign(
										function (e, t, n) {
											if (n) {
												...
												if (!(0, Kt.default)("Identifier", e.key))
													throw new TypeError(
				...
				validate: {}.BABEL_TYPES_8_BREAKING
					? (() => {
							let r = (0, m.assertNodeType)(
								...
								i = (0, m.assertNodeType)("Expression");
							return function (e, t, n) {
								((0, Kt.default)("ObjectPattern", e) ? r : i)(n, "value", n.value);
							};
						})()
					: void 0
			}),
			...
			f("UnaryExpression", {
				...
				fields: {
					...
					operator: { validate: (0, m.assertOneOf)(...Xt.UNARY_OPERATORS) }
				},
				visitor: ["argument"],
			...
			f("UpdateExpression", {
				...
				fields: {
					...
					operator: { validate: (0, m.assertOneOf)(...Xt.UPDATE_OPERATORS) }
				},
				visitor: ["argument"],
				aliases: ["Expression"]
			}),
			f("VariableDeclaration", {
				...
				validate: {}.BABEL_TYPES_8_BREAKING
					? (() => {
							let r = (0, m.assertNodeType)("Identifier");
							return function (e, t, n) {
								if ((0, Kt.default)("ForXStatement", e, { left: n })) {
			...
			fields: {
				left: {
					validate: (() => {
						...
						return Object.assign(
							function (e, t, n) {
								((0, Kt.default)("VariableDeclaration", n) ? r : i)(e, t, n);
							},
							{
								oneOfNodeTypes: [
									"VariableDeclaration",
						...
						? (0, m.chain)(
								...
								Object.assign(
									function (e, t, n) {
										...
										if (!(0, Kt.default)("Identifier", e.property, { name: r }))
	...
	p.classMethodOrPropertyCommon = Ut;
	var h = () =>
			Object.assign({}, qt(), Ut(), {
						...
						validate: (0, m.chain)(
							...
							function (e) {
								...
								var r = () => {
									...
									{ str: t, firstInvalidLoc: r } = (0, Jt.readStringContents)(
										"template",
										t,
										0,
										0,
...
Expected ${n.length + 1} quasis but got ` + e.quasis.length
	...
	(f = (0, (c = y).defineAliasedType)("JSX"))("JSXAttribute", {
		visitor: ["name", "value"],
		aliases: ["Immutable"],
		fields: {
		...
		f("JSXExpressionContainer", {
			...
			aliases: ["Immutable"],
			fields: {
				expression: { validate: (0, c.assertNodeType)("Expression", "JSXEmptyExpression") }
			}
		}),
		f("JSXSpreadChild", {
			visitor: ["expression"],
		...
		f("JSXMemberExpression", {
			visitor: ["object", "property"],
			fields: {
				object: { validate: (0, c.assertNodeType)("JSXMemberExpression", "JSXIdentifier") },
			...
			fields: Object.assign(
				{
					...
					attributes: (0, c.validateArrayOfType)("JSXAttribute", "JSXSpreadAttribute"),
					typeArguments: {
	...
	let zt = (d.PLACEHOLDERS_ALIAS = {
		Declaration: ["Statement"],
		Pattern: ["PatternLike", "LVal"]
	});
	for (Wt of h) {
		var Ht = Gt.ALIAS_KEYS[Wt];
		null != Ht && Ht.length && (zt[Wt] = Ht);
	}
	let $t = (d.PLACEHOLDERS_FLIPPED_ALIAS = {});
	Object.keys(zt).forEach(t => {
		zt[t].forEach(e => {
			hasOwnProperty.call($t, e) || ($t[e] = []), $t[e].push(t);
		});
	});
	(f = d), (h = p);
	(P = (0, (c = y).defineAliasedType)("Miscellaneous"))("Noop", { visitor: [] }),
		P("Placeholder", {
			visitor: [],
		...
		P("V8IntrinsicIdentifier", {
			builder: ["name"],
			fields: { name: { validate: (0, c.assertValueType)("string") } }
		});
	(0, (f = y).default)("ArgumentPlaceholder", {}),
		(0, f.default)("BindExpression", {
			...
			fields: {}.BABEL_TYPES_8_BREAKING
				...
				: {
						object: {
							validate: Object.assign(() => {}, { oneOfNodeTypes: ["Expression"] })
						},
						callee: {
							validate: Object.assign(() => {}, { oneOfNodeTypes: ["Expression"] })
						}
		...
		(0, f.default)("RecordExpression", {
			visitor: ["properties"],
			aliases: ["Expression"],
			fields: { properties: (0, f.validateArrayOfType)("ObjectProperty", "SpreadElement") }
		}),
	...
	var E = y,
		h = p,
		Qt = Be,
		v = (0, E.defineAliasedType)("TypeScript");
	let Zt = (0, E.assertValueType)("boolean");
	var en,
		P = () => ({
			returnType: {
	...
	v("TSParameterProperty", {
		...
		fields: {
			...
			parameter: { validate: (0, E.assertNodeType)("Identifier", "AssignmentPattern") },
		...
		v("TSDeclareFunction", {
			...
			fields: Object.assign({}, (0, h.functionDeclarationCommon)(), P())
		}),
		v("TSDeclareMethod", {
			visitor: ["decorators", "key", "typeParameters", "params", "returnType"],
			fields: Object.assign({}, (0, h.classMethodOrDeclareMethodCommon)(), P())
		}),
		v("TSQualifiedName", {
	...
	var f = {
		...
		p =
			(v("TSCallSignatureDeclaration", f),
			v("TSConstructSignatureDeclaration", f),
			() => ({
				key: (0, E.validateType)("Expression"),
				computed: { default: !1 },
				optional: (0, E.validateOptional)(Zt)
			}));
	v("TSPropertySignature", {
		aliases: ["TSTypeElement"],
		visitor: ["key", "typeAnnotation"],
		fields: Object.assign({}, p(), {
			readonly: (0, E.validateOptional)(Zt),
			typeAnnotation: (0, E.validateOptionalType)("TSTypeAnnotation"),
			kind: { optional: !0, validate: (0, E.assertOneOf)("get", "set") }
		})
	}),
		v("TSMethodSignature", {
			aliases: ["TSTypeElement"],
		...
		v("TSIndexSignature", {
			...
			fields: {
				readonly: (0, E.validateOptional)(Zt),
				static: (0, E.validateOptional)(Zt),
	...
	for (en of [
		...
		v(en, { aliases: ["TSType", "TSBaseType"], visitor: [], fields: {} });
	v("TSThisType", { aliases: ["TSType", "TSBaseType"], visitor: [], fields: {} });
	var tn,
		nn,
		rn,
		h = { aliases: ["TSType"], visitor: ["typeParameters", "parameters", "typeAnnotation"] },
		P =
			(v("TSFunctionType", Object.assign({}, h, { fields: c() })),
			v(
				"TSConstructorType",
				Object.assign({}, h, {
					fields: Object.assign({}, c(), { abstract: (0, E.validateOptional)(Zt) })
				})
			),
			v("TSTypeReference", {
				aliases: ["TSType"],
			...
			v("TSTypePredicate", {
				...
				fields: {
					...
					typeAnnotation: (0, E.validateOptionalType)("TSTypeAnnotation"),
					asserts: (0, E.validateOptional)(Zt)
				}
			}),
			v("TSTypeQuery", {
				aliases: ["TSType"],
			...
			v("TSNamedTupleMember", {
				...
				fields: {
					...
					optional: { validate: Zt, default: !1 },
		...
		f =
			...
			v("TSTemplateLiteralType", {
				aliases: ["TSType", "TSBaseType"],
				visitor: ["quasis", "types"],
				fields: {
					quasis: (0, E.validateArrayOfType)("TemplateElement"),
					types: {
						validate: (0, E.chain)(
...
Expected ${n.length + 1} quasis but got ` + e.quasis.length
			...
			v("TSLiteralType", {
				...
				fields: {
					literal: {
						validate: (() => {
							let r = (0, E.assertNodeType)("NumericLiteral", "BigIntLiteral"),
								i = (0, E.assertOneOf)("-"),
								a = (0, E.assertNodeType)(
									"NumericLiteral",
									"StringLiteral",
									"BooleanLiteral",
									"BigIntLiteral",
							...
							function e(e, t, n) {
								(0, Qt.default)("UnaryExpression", n)
			...
			v("TSInterfaceDeclaration", {
				...
				fields: {
					declare: (0, E.validateOptional)(Zt),
		...
		p =
			...
			v("TSEnumBody", {
				visitor: ["members"],
				fields: { members: (0, E.validateArrayOfType)("TSEnumMember") }
			}),
			v("TSEnumDeclaration", {
				aliases: ["Statement", "Declaration"],
				visitor: ["id", "members"],
			...
			v("TSModuleDeclaration", {
				...
				fields: Object.assign(
					{
						kind: { validate: (0, E.assertOneOf)("global", "module", "namespace") },
						declare: (0, E.validateOptional)(Zt)
					},
					{ global: (0, E.validateOptional)(Zt) },
					{
						id: (0, E.validateType)("Identifier", "StringLiteral"),
			...
			v("TSImportType", {
				...
				fields: {
					...
					typeParameters: (0, E.validateOptionalType)("TSTypeParameterInstantiation"),
					options: { validate: (0, E.assertNodeType)("Expression"), optional: !0 }
				}
			}),
			v("TSImportEqualsDeclaration", {
				...
				fields: Object.assign(
					...
					{ isExport: (0, E.validate)(Zt) },
					{
						...
						importKind: { validate: (0, E.assertOneOf)("type", "value"), optional: !0 }
					}
				)
			}),
		...
		an =
			...
			Object.defineProperty(h, "VISITOR_KEYS", {
				enumerable: !0,
				get: function () {
					return tn.VISITOR_KEYS;
				}
			}),
			(tn = y),
			(nn = d),
			(rn = p),
			Object.keys(rn.DEPRECATED_ALIASES).forEach(e => {
				tn.FLIPPED_ALIAS_KEYS[e] = tn.FLIPPED_ALIAS_KEYS[rn.DEPRECATED_ALIASES[e]];
			}),
			(h.TYPES = [].concat(
				Object.keys(tn.VISITOR_KEYS),
				Object.keys(tn.FLIPPED_ALIAS_KEYS),
				Object.keys(tn.DEPRECATED_KEYS)
			)),
			Object.defineProperty(Le, "__esModule", { value: !0 }),
			(Le.default = function (e, t, n) {
				var r;
				e && (r = an.NODE_FIELDS[e.type]) && ((r = r[t]), on(e, t, n, r), sn(e, t, n));
			}),
			(Le.validateChild = sn),
			(Le.validateField = on),
			(Le.validateInternal = function (e, t, n, r, i) {
				null == e ||
					!e.validate ||
					(e.optional && null == r) ||
					(e.validate(t, n, r),
					i &&
						null != (e = r.type) &&
						null != (i = an.NODE_PARENT_VALIDATIONS[e]) &&
						i.call(an.NODE_PARENT_VALIDATIONS, t, n, r));
			}),
			Me);
	function on(e, t, n, r) {
	...
	function sn(e, t, n) {
		...
		null != r &&
			null != (r = an.NODE_PARENT_VALIDATIONS[r]) &&
			r.call(an.NODE_PARENT_VALIDATIONS, e, t, n);
	}
	Object.defineProperty(l, "__esModule", { value: !0 }),
		...
		(l.numberLiteral = function (e) {
			return (0, ln.default)("NumberLiteral", "NumericLiteral", "The node type "), pn(e);
		}),
		...
		(l.regexLiteral = function (e, t = "") {
			return (0, ln.default)("RegexLiteral", "RegExpLiteral", "The node type "), un(e, t);
		}),
		(l.restElement = cn),
		(l.restProperty = function (e) {
			return (0, ln.default)("RestProperty", "RestElement", "The node type "), cn(e);
		}),
		...
		(l.spreadProperty = function (e) {
			return (0, ln.default)("SpreadProperty", "SpreadElement", "The node type "), dn(e);
		}),
	...
	(P = c = {}),
		...
		Object.defineProperty(P, "ImportExpression", {
			enumerable: !0,
			get: function () {
		...
		Object.defineProperty(P, "TSEnumBody", {
			enumerable: !0,
			get: function () {
				return O.tsEnumBody;
			}
		...
		Object.defineProperty(P, "TSSatisfiesExpression", {
			enumerable: !0,
			get: function () {
		...
		Object.defineProperty(P, "TSTemplateLiteralType", {
			enumerable: !0,
			get: function () {
		...
		(o.default = function (e, t) {
			...
			i && t.push((0, hn.inherits)((0, Tn.stringLiteral)(i), e));
		});
	var O,
		fn,
		yn,
		...
		Sn =
			(Object.defineProperty(ke, "__esModule", { value: !0 }),
			(ke.default = function (n) {
				var r = [];
				for (let t = 0; t < n.children.length; t++) {
					let e = n.children[t];
					(0, Sn.isJSXText)(e)
						? (0, bn.default)(e, r)
						: ((0, Sn.isJSXExpressionContainer)(e) && (e = e.expression),
							(0, Sn.isJSXEmptyExpression)(e) || r.push(e));
				}
				return r;
			}),
			i),
			...
			(f.default = function (e) {
				{
					...
					if (!(0, vn.default)(e))
						throw (
							((t =
								null != (t = null == e ? void 0 : e.type) ? t : JSON.stringify(e)),
		...
		gn =
			...
			(p.assertModuleDeclaration = function (e, t) {
				(0, Pn.default)("assertModuleDeclaration", "assertImportOrExportDeclaration"),
			...
			(p.assertNumberLiteral = function (e, t) {
				(0, Pn.default)("assertNumberLiteral", "assertNumericLiteral"),
					_("NumberLiteral", e, t);
			}),
			...
			(p.assertRegexLiteral = function (e, t) {
				(0, Pn.default)("assertRegexLiteral", "assertRegExpLiteral"),
					_("RegexLiteral", e, t);
			}),
			...
			(p.assertRestProperty = function (e, t) {
				(0, Pn.default)("assertRestProperty", "assertRestElement"), _("RestProperty", e, t);
			}),
			...
			(p.assertSpreadProperty = function (e, t) {
				(0, Pn.default)("assertSpreadProperty", "assertSpreadElement"),
		...
		Pn = _e;
	function _(e, t, n) {
		if (!(0, gn.default)(e, t, n))
			throw new Error(
				`Expected type "${e}" with option ${JSON.stringify(n)}, but instead got "${t.type}".`
			);
	}
	var h = {},
		xn = (Object.defineProperty(h, "__esModule", { value: !0 }), (h.default = void 0), s),
		y =
			((h.default = function (e) {
				switch (e) {
					case "string":
						return (0, xn.stringTypeAnnotation)();
					case "number":
						return (0, xn.numberTypeAnnotation)();
					case "undefined":
						return (0, xn.voidTypeAnnotation)();
					case "boolean":
						return (0, xn.booleanTypeAnnotation)();
					case "function":
						return (0, xn.genericTypeAnnotation)((0, xn.identifier)("Function"));
					case "object":
						return (0, xn.genericTypeAnnotation)((0, xn.identifier)("Object"));
					case "symbol":
						return (0, xn.genericTypeAnnotation)((0, xn.identifier)("Symbol"));
					case "bigint":
						return (0, xn.anyTypeAnnotation)();
				}
		...
		An =
			...
			(P.default = function r(e) {
				...
				for (let e = 0; e < t.length; e++) {
					let n = t[e];
					if (n && !s.includes(n)) {
						if ((0, An.isAnyTypeAnnotation)(n)) return [n];
						if ((0, An.isFlowBaseAnnotation)(n)) a.set(n.type, n);
						else if ((0, An.isUnionTypeAnnotation)(n))
							o.has(n.types) || (t.push(...n.types), o.add(n.types));
						else if ((0, An.isGenericTypeAnnotation)(n)) {
							let t = On(n.id);
							if (i.has(t)) {
								let e = i.get(t);
								e.typeParameters
			...
			i);
	function On(e) {
		return (0, An.isIdentifier)(e) ? e.name : e.id.name + "." + On(e.qualification);
	}
	Object.defineProperty(y, "__esModule", { value: !0 }),
		(y.default = function (e) {
			e = (0, In.default)(e);
			return 1 === e.length ? e[0] : (0, _n.unionTypeAnnotation)(e);
		});
	var _n = s,
		In = P,
		l = {},
		...
		Cn =
			...
			(c.default = function a(e) {
				...
				for (let t = 0; t < n.length; t++) {
					let e = n[t];
					if (e && !s.includes(e)) {
						if ((0, Cn.isTSAnyKeyword)(e)) return [e];
						if ((0, Cn.isTSBaseType)(e)) r.set(e.type, e);
						else if ((0, Cn.isTSUnionType)(e))
							i.has(e.types) || (n.push(...e.types), i.add(e.types));
						else {
							let i = "typeParameters";
							if ((0, Cn.isTSTypeReference)(e) && e[i]) {
								let n = e[i],
									r = Dn(e.typeName);
								if (o.has(r)) {
									let e = o.get(r),
			...
			i);
	function Dn(e) {
		return (0, Cn.isIdentifier)(e)
			? e.name
			: (0, Cn.isThisExpression)(e)
				? "this"
				: e.right.name + "." + Dn(e.left);
	}
	Object.defineProperty(l, "__esModule", { value: !0 }),
		(l.default = function (e) {
			(e = e.map(e => ((0, jn.isTSTypeAnnotation)(e) ? e.typeAnnotation : e))),
				(e = (0, wn.default)(e));
			return 1 === e.length ? e[0] : (0, Nn.tsUnionType)(e);
		});
	var Nn = s,
		wn = c,
		jn = i,
		...
		kn =
			...
			(o.buildUndefinedNode = function () {
				return (0, kn.unaryExpression)("void", (0, kn.numericLiteral)(0), !0);
			}),
			s),
		c = {},
		Ln =
			...
			(c.default = function (e, t = !0, n = !1) {
				return Kn(e, t, n, new Map());
			}),
			Me),
		Mn = i;
	let Bn = { hasOwn: Function.call.bind(Object.prototype.hasOwnProperty) }.hasOwn;
	function Fn(e, t, n, r) {
		return e && "string" == typeof e.type ? Kn(e, t, n, r) : e;
	}
	function Rn(e, t, n, r) {
		return Array.isArray(e) ? e.map(e => Fn(e, t, n, r)) : Fn(e, t, n, r);
	}
	function Kn(e, t = !0, n = !1, r) {
		if (!e) return e;
		var i = e.type,
			a = { type: e.type };
		if ((0, Mn.isIdentifier)(e))
			(a.name = e.name),
				Bn(e, "optional") && "boolean" == typeof e.optional && (a.optional = e.optional),
				Bn(e, "typeAnnotation") &&
					(a.typeAnnotation = t ? Rn(e.typeAnnotation, !0, n, r) : e.typeAnnotation),
				Bn(e, "decorators") &&
					(a.decorators = t ? Rn(e.decorators, !0, n, r) : e.decorators);
		else {
			if (!Bn(Ln.NODE_FIELDS, i)) throw new Error(`Unknown node type: "${i}"`);
			for (var o of Object.keys(Ln.NODE_FIELDS[i]))
				Bn(e, o) &&
					(a[o] = t
						? (0, Mn.isFile)(e) && "comments" === o
							? Yn(e.comments, t, n, r)
							: Rn(e[o], !0, n, r)
						: e[o]);
		}
		return (
			Bn(e, "loc") && (a.loc = n ? null : e.loc),
			Bn(e, "leadingComments") && (a.leadingComments = Yn(e.leadingComments, t, n, r)),
			Bn(e, "innerComments") && (a.innerComments = Yn(e.innerComments, t, n, r)),
			Bn(e, "trailingComments") && (a.trailingComments = Yn(e.trailingComments, t, n, r)),
			Bn(e, "extra") && (a.extra = Object.assign({}, e.extra)),
			a
		);
	}
	function Yn(e, t, i, a) {
	...
	var I = {},
		Vn =
			...
			(I.default = function (e) {
				return (0, Vn.default)(e, !1);
			}),
			c),
		Jn = {},
		Xn =
			(Object.defineProperty(Jn, "__esModule", { value: !0 }),
			(Jn.default = function (e) {
				return (0, Xn.default)(e);
			}),
			c),
		qn = {},
		Un =
			...
			(qn.default = function (e) {
				return (0, Un.default)(e, !0, !0);
			}),
			c),
		Wn = {},
		Gn =
			(Object.defineProperty(Wn, "__esModule", { value: !0 }),
			(Wn.default = function (e) {
				return (0, Gn.default)(e, !1, !0);
			}),
			c),
		C = {},
		zn = {},
		...
		Qn =
			...
			(D.default = function (e, t) {
				(0, Qn.default)("innerComments", e, t);
			}),
			$n),
		N = {},
		Zn =
			...
			(N.default = function (e, t) {
				(0, Zn.default)("leadingComments", e, t);
			}),
			$n),
		er = {},
		tr = {},
		nr =
			...
			(tr.default = function (e, t) {
				(0, nr.default)("trailingComments", e, t);
			}),
			$n),
		rr =
			(Object.defineProperty(er, "__esModule", { value: !0 }),
			(er.default = function (e, t) {
				return (0, rr.default)(e, t), (0, ir.default)(e, t), (0, ar.default)(e, t), e;
			}),
			tr),
		ir = N,
		ar = D,
		...
		j =
			...
			(w.MODULEDECLARATION_TYPES = sr),
			{}),
		sr = {},
		lr =
			(Object.defineProperty(sr, "__esModule", { value: !0 }),
			(sr.default = function (e, t) {
				if ((0, lr.isBlockStatement)(e)) return e;
				let n = [];
				n = (0, lr.isEmptyStatement)(e)
					? []
					: ((0, lr.isStatement)(e) ||
							(e = (
								(0, lr.isFunction)(t)
									? (0, pr.returnStatement)
									: (0, pr.expressionStatement)
							)(e)),
						[e]);
				return (0, pr.blockStatement)(n);
			}),
			i),
		pr = s,
		ur =
		...
		fr =
			...
			(dr.default = function (e) {
				let t = "";
				for (var n of (e += "")) t += (0, yr.isIdentifierChar)(n.codePointAt(0)) ? n : "-";
				(t = (t = t.replace(/^[-0-9]+/, "")).replace(/[-\s]+(.)?/g, function (e, t) {
					return t ? t.toUpperCase() : "";
				})),
					(0, fr.default)(t) || (t = "_" + t);
				return t || "_";
			}),
			Ue),
		yr = We,
		mr =
			...
			(cr.default = function (e) {
				("eval" !== (e = (0, mr.default)(e)) && "arguments" !== e) || (e = "_" + e);
				return e;
			}),
			dr),
		We = {},
		Tr =
			...
			(We.default = function (e, t = e.key || e.property) {
				!e.computed && (0, Tr.isIdentifier)(t) && (t = (0, hr.stringLiteral)(t.name));
				return t;
			}),
			i),
		hr = s,
		Sr = {},
		br = (Object.defineProperty(Sr, "__esModule", { value: !0 }), (Sr.default = void 0), i),
		Er =
			((Sr.default = function (e) {
				(0, br.isExpressionStatement)(e) && (e = e.expression);
				if ((0, br.isExpression)(e)) return e;
				(0, br.isClass)(e)
					? (e.type = "ClassExpression")
					: (0, br.isFunction)(e) && (e.type = "FunctionExpression");
				if ((0, br.isExpression)(e)) return e;
		...
		Pr =
			...
			(gr.default = function t(n, r, i) {
				if (!n) return;
				let e = Pr.VISITOR_KEYS[n.type];
				if (!e) return;
				i = i || {};
				r(n, i);
				for (var a of e) {
	...
	let Ar = ["tokens", "start", "end", "loc", "raw", "rawValue"],
		Or = [...u.COMMENT_KEYS, "comments", ...Ar];
	Object.defineProperty(vr, "__esModule", { value: !0 }),
		(vr.default = function (e, t) {
			return (0, _r.default)(e, Ir.default, t), e;
		});
	var _r = gr,
		Ir = xr,
		Cr = (Object.defineProperty(Er, "__esModule", { value: !0 }), (Er.default = wr), i),
		Dr = c,
		Nr = vr;
	function wr(e, t = e.key) {
		...
		return "method" === e.kind
			? wr.increment() + ""
			: ((n = (0, Cr.isIdentifier)(t)
					? t.name
					: (0, Cr.isStringLiteral)(t)
						? JSON.stringify(t.value)
						: JSON.stringify((0, Nr.default)((0, Dr.default)(t)))),
				e.computed && (n = `[${n}]`),
				(n = e.static ? "static:" + n : n));
	}
	(wr.uid = 0),
		(wr.increment = function () {
			return wr.uid >= Number.MAX_SAFE_INTEGER ? (wr.uid = 0) : wr.uid++;
		});
	var jr = {},
		kr = (Object.defineProperty(jr, "__esModule", { value: !0 }), (jr.default = void 0), i),
		Lr = s,
		Mr =
			((jr.default = function (n, r) {
				if (!(0, kr.isStatement)(n)) {
					let e = !1,
						t;
					if ((0, kr.isClass)(n)) (e = !0), (t = "ClassDeclaration");
					else if ((0, kr.isFunction)(n)) (e = !0), (t = "FunctionDeclaration");
					else if ((0, kr.isAssignmentExpression)(n))
						return (0, Lr.expressionStatement)(n);
					if (!(t = e && !n.id ? !1 : t)) {
						if (r) return !1;
			...
			{}),
		Br = (Object.defineProperty(Mr, "__esModule", { value: !0 }), (Mr.default = void 0), Ue),
		Fr = s;
	Mr.default = function n(r) {
		if (void 0 === r) return (0, Fr.identifier)("undefined");
		if (!0 === r || !1 === r) return (0, Fr.booleanLiteral)(r);
		if (null === r) return (0, Fr.nullLiteral)();
		if ("string" == typeof r) return (0, Fr.stringLiteral)(r);
		if ("number" == typeof r) {
			let t;
			if (Number.isFinite(r)) t = (0, Fr.numericLiteral)(Math.abs(r));
			else {
				let e;
				(e = Number.isNaN(r) ? (0, Fr.numericLiteral)(0) : (0, Fr.numericLiteral)(1)),
					(t = (0, Fr.binaryExpression)("/", e, (0, Fr.numericLiteral)(0)));
			}
			return (t = r < 0 || Object.is(r, -0) ? (0, Fr.unaryExpression)("-", t) : t);
		}
		if (Kr(r)) {
			let e = r.source,
				t = /\/([a-z]*)$/.exec(r.toString())[1];
			return (0, Fr.regExpLiteral)(e, t);
		}
		if (Array.isArray(r)) return (0, Fr.arrayExpression)(r.map(n));
		if (Yr(r)) {
			let t = [];
			for (var i of Object.keys(r)) {
				let e;
				(e = ((0, Br.default)(i) ? (0, Fr.identifier) : (0, Fr.stringLiteral))(i)),
					t.push((0, Fr.objectProperty)(e, n(r[i])));
			}
			return (0, Fr.objectExpression)(t);
		}
		throw new Error("don't know how to turn this value into a node");
	};
	let Rr = Function.call.bind(Object.prototype.toString);
	function Kr(e) {
		return "[object RegExp]" === Rr(e);
	}
	function Yr(e) {
		return (
			"object" == typeof e &&
	...
	var Vr = {},
		Jr =
			(Object.defineProperty(Vr, "__esModule", { value: !0 }),
			(Vr.default = function (e, t, n = !1) {
				return (
					(e.object = (0, Jr.memberExpression)(e.object, e.property, e.computed)),
					(e.property = t),
					(e.computed = !!n),
					e
				);
		...
		qr =
			...
			(Xr.default = function (e, t) {
				if (e && t) {
					for (var n of qr.INHERIT_KEYS.optional) null == e[n] && (e[n] = t[n]);
					for (var r of Object.keys(t)) "_" === r[0] && "__clone" !== r && (e[r] = t[r]);
					for (var i of qr.INHERIT_KEYS.force) e[i] = t[i];
					(0, Ur.default)(e, t);
				}
				return e;
			}),
		...
		Gr =
			...
			(Wr.default = function (e, t) {
				if ((0, zr.isSuper)(e.object))
					throw new Error("Cannot prepend node to super property access (`super.foo`).");
				return (e.object = (0, Gr.memberExpression)(t, e.object)), e;
			}),
			s),
		zr = e,
		Hr = {},
		$r =
			...
			{}),
		Qr = (Object.defineProperty($r, "__esModule", { value: !0 }), ($r.default = Zr), i);
	function Zr(e, t, n, r) {
		for (var i = [].concat(e), a = Object.create(null); i.length; ) {
			...
			if (o)
				if (
					!r ||
					!(
						(0, Qr.isAssignmentExpression)(o) ||
						(0, Qr.isUnaryExpression)(o) ||
						(0, Qr.isUpdateExpression)(o)
					)
				)
					if ((0, Qr.isIdentifier)(o))
						t ? (a[o.name] = a[o.name] || []).push(o) : (a[o.name] = o);
					else if ((0, Qr.isExportDeclaration)(o) && !(0, Qr.isExportAllDeclaration)(o))
						(0, Qr.isDeclaration)(o.declaration) && i.push(o.declaration);
					else {
						if (n) {
							if ((0, Qr.isFunctionDeclaration)(o)) {
								i.push(o.id);
								continue;
							}
							if ((0, Qr.isFunctionExpression)(o)) continue;
						}
						var s = Zr.keys[o.type];
						if (s)
							for (let e = 0; e < s.length; e++) {
								var l = o[s[e]];
	...
	var ei = {},
		ti = (Object.defineProperty(ei, "__esModule", { value: !0 }), (ei.default = void 0), $r),
		ni =
			((ei.default = function (e, t) {
				return (0, ti.default)(e, t, !0);
			}),
			{}),
		ri =
			(Object.defineProperty(ni, "__esModule", { value: !0 }),
			(ni.default = function (e, t) {
				if ("id" in e && e.id) return { name: e.id.name, originalNode: e.id };
				let n = "",
					r;
				(0, ri.isObjectProperty)(t, { value: e })
					? (r = ii(t))
					: (0, ri.isObjectMethod)(e) || (0, ri.isClassMethod)(e)
						? ((r = ii(e)),
							"get" === e.kind ? (n = "get ") : "set" === e.kind && (n = "set "))
						: (0, ri.isVariableDeclarator)(t, { init: e })
							? (r = t.id)
							: (0, ri.isAssignmentExpression)(t, { operator: "=", right: e }) &&
								(r = t.left);
				if (!r) return null;
				e = (0, ri.isLiteral)(r)
					? (e =>
							(0, ri.isNullLiteral)(e)
								? "null"
								: (0, ri.isRegExpLiteral)(e)
									? `/${e.pattern}/` + e.flags
									: (0, ri.isTemplateLiteral)(e)
			...
			i);
	function ii(e) {
		if (!e.computed || (0, ri.isLiteral)(e.key)) return e.key;
	}
	var ai = {},
		oi =
			(Object.defineProperty(ai, "__esModule", { value: !0 }),
			(ai.default = function (e, t, n) {
				"function" == typeof t && (t = { enter: t });
				var { enter: t, exit: r } = t;
				!(function r(i, a, o, s, l) {
					let e = oi.VISITOR_KEYS[i.type];
					if (!e) return;
					a && a(i, l, s);
					for (var p of e) {
						let n = i[p];
		...
		ci =
			...
			(ui.default = function (e) {
				return (
					(0, ci.isVariableDeclaration)(e) &&
					("var" !== e.kind || e[di.BLOCK_SCOPED_SYMBOL])
				);
			}),
			i),
		di = u,
			...
			(pi.default = function (e) {
				return (
					(0, fi.isFunctionDeclaration)(e) ||
					(0, fi.isClassDeclaration)(e) ||
					(0, yi.default)(e)
				);
			}),
			i),
		...
		Ti =
			...
			(mi.default = function (e) {
				if ((0, Ti.default)(e.type, "Immutable")) return !0;
				if ((0, hi.isIdentifier)(e) && "undefined" === e.name) return !0;
				return !1;
			}),
			Fe),
		hi = i,
		...
		bi =
			(Object.defineProperty(Si, "__esModule", { value: !0 }),
			(Si.default = function r(e, i) {
				if ("object" != typeof e || "object" != typeof i || null == e || null == i)
					return e === i;
				if (e.type !== i.type) return !1;
				let t = Object.keys(bi.NODE_FIELDS[e.type] || e.type);
				let a = bi.VISITOR_KEYS[e.type];
				for (var o of t) {
					let t = e[o],
						n = i[o];
		...
		gi =
			...
			(vi.default = function (e, t) {
				if (
					(0, gi.isBlockStatement)(e) &&
					((0, gi.isFunction)(t) || (0, gi.isCatchClause)(t))
				)
					return !1;
				if ((0, gi.isPattern)(e) && ((0, gi.isFunction)(t) || (0, gi.isCatchClause)(t)))
					return !0;
				return (0, gi.isScopable)(e);
			}),
			i),
		Pi = {},
		xi =
			...
			(Pi.default = function (e) {
				return (
					(0, xi.isImportDefaultSpecifier)(e) ||
					(0, xi.isIdentifier)(e.imported || e.exported, { name: "default" })
				);
			}),
			i),
		Ai = {},
		Oi =
			(Object.defineProperty(Ai, "__esModule", { value: !0 }),
			(Ai.default = function (e) {
				return (0, Oi.default)(e) && !_i.has(e);
			}),
			Ue);
	let _i = new Set([
		"abstract",
	...
	var Ii = {},
		Ci =
			...
			(Ii.default = function (e) {
				return (
					(0, Ci.isVariableDeclaration)(e, { kind: "var" }) && !e[Di.BLOCK_SCOPED_SYMBOL]
				);
			}),
			i),
		Di = u,
		...
		ji =
			...
			(wi.default = function n(e, r) {
				let i = [];
				let t = !0;
				for (var a of e)
					if (((0, ki.isEmptyStatement)(a) || (t = !1), (0, ki.isExpression)(a)))
						i.push(a);
					else if ((0, ki.isExpressionStatement)(a)) i.push(a.expression);
					else if ((0, ki.isVariableDeclaration)(a)) {
						if ("var" !== a.kind) return;
						for (var o of a.declarations) {
							let e = (0, ji.default)(o);
							for (var s of Object.keys(e))
								r.push({ kind: a.kind, id: (0, Bi.default)(e[s]) });
							o.init && i.push((0, Li.assignmentExpression)("=", o.id, o.init));
						}
						t = !0;
					} else if ((0, ki.isIfStatement)(a)) {
						let e = a.consequent ? n([a.consequent], r) : (0, Mi.buildUndefinedNode)(),
							t = a.alternate ? n([a.alternate], r) : (0, Mi.buildUndefinedNode)();
						if (!e || !t) return;
						i.push((0, Li.conditionalExpression)(a.test, e, t));
					} else if ((0, ki.isBlockStatement)(a)) {
						let e = n(a.body, r);
						if (!e) return;
						i.push(e);
					} else {
						if (!(0, ki.isEmptyStatement)(a)) return;
						0 === e.indexOf(a) && (t = !0);
					}
				t && i.push((0, Mi.buildUndefinedNode)());
				return 1 === i.length ? i[0] : (0, Li.sequenceExpression)(i);
			}),
			$r),
		ki = i,
		Li = s,
	...
	(k = e),
		...
		Object.keys(Ki).forEach(function (e) {
			"default" === e ||
				"__esModule" === e ||
				Object.prototype.hasOwnProperty.call(Fi, e) ||
				(e in k && k[e] === Ki[e]) ||
		...
		(ke = Ni),
		(k.react = {
			isReactComponent: wi.default,
			isCompatTag: n.default,
			buildChildren: je.default
		}),
		(k.toSequenceExpression = ke.default),
		{}.BABEL_TYPES_8_BREAKING &&
			console.warn(
	...
	let Ha = e,
		{
			FLIPPED_ALIAS_KEYS: $a,
			isArrayExpression: Qa,
			isAssignmentExpression: Za,
			isBinary: eo,
			isBlockStatement: to,
			isCallExpression: no,
			isFunction: ro,
			isIdentifier: io,
			isLiteral: ao,
			isMemberExpression: oo,
			isObjectExpression: so,
			isOptionalCallExpression: lo,
						...
						: eo(t) || Za(t)
							...
							: no(t) || lo(t)
								...
								: ro(t)
									? (n.hasFunction = !0)
									: io(t) &&
										(n.hasHelper = n.hasHelper || (t.callee && fo(t.callee)))),
				n
			);
	...
	function fo(e) {
		return (
			!!e &&
			(oo(e)
				? fo(e.object) || fo(e.property)
				: io(e)
					? "require" === e.name || 95 === e.name.charCodeAt(0)
					: no(e)
						? fo(e.callee)
						: !(!eo(e) && !Za(e)) && ((io(e.left) && fo(e.left)) || fo(e.right)))
		);
	}
	let yo = (r.nodes = {
		...
		LogicalExpression(e) {
			if (ro(e.left) || ro(e.right)) return 2;
		},
		Literal(e) {
			if (uo(e) && "use strict" === e.value) return 2;
		},
		CallExpression(e) {
			if (ro(e.callee) || fo(e)) return 3;
		},
		OptionalCallExpression(e) {
			if (ro(e.callee)) return 3;
		},
		VariableDeclaration(n) {
			for (let t = 0; t < n.declarations.length; t++) {
				var r = n.declarations[t];
				let e = fo(r.id) && ((i = r.init), !(ao(i) || so(i) || Qa(i) || io(i) || oo(i)));
				if (
					(!e &&
						r.init &&
						((i = co(r.init)), (e = (fo(r.init) && i.hasCall) || i.hasFunction)),
					e)
				)
					return 3;
			}
		...
		IfStatement(e) {
			if (to(e.consequent)) return 3;
		}
	});
	(yo.ObjectProperty =
		yo.ObjectTypeProperty =
		yo.ObjectMethod =
			function (e, t) {
				if (t.properties[0] === e) return 1;
			}),
		(yo.ObjectTypeCallProperty = function (e, t) {
			if (t.callProperties[0] === e && (null == (e = t.properties) || !e.length)) return 1;
		}),
		(yo.ObjectTypeIndexer = function (e, t) {
			if (
				!(
					t.indexers[0] !== e ||
		...
		(yo.ObjectTypeInternalSlot = function (e, t) {
			if (
				!(
					t.internalSlots[0] !== e ||
					(null != (e = t.properties) && e.length) ||
		...
		[
			...
			[e].concat($a[e] || []).forEach(function (e) {
				let t = n ? 3 : 0;
				yo[e] = () => t;
			});
		}),
		...
		(f.ClassExpression = function (e, t, n) {
			return Boolean(
				n & (mo.TokenContext.expressionStatement | mo.TokenContext.exportDefault)
			);
		}),
		(f.ArrowFunctionExpression = f.ConditionalExpression = ko),
		(f.DoExpression = function (e, t, n) {
			return !e.async && Boolean(n & mo.TokenContext.expressionStatement);
		}),
		...
		(f.FunctionTypeAnnotation = function (e, t, n) {
			...
			return (
				...
				Boolean(n & mo.TokenContext.arrowFlowReturnType)
			);
		}),
		(f.Identifier = function (e, t, n, r, i) {
			...
			if ("let" !== e.name) return "async" === e.name && bo(t, { left: e, await: !1 });
			return (
				!!(
					(vo(t, { object: e, computed: !0 }) ||
						Po(t, { object: e, computed: !0, optional: !1 })) &&
					n &
						(mo.TokenContext.expressionStatement |
							mo.TokenContext.forHead |
							mo.TokenContext.forInHead)
				) || Boolean(n & mo.TokenContext.forOfHead)
			);
		}),
		...
		(f.OptionalIndexedAccessType = function (e, t) {
			return Eo(t) && t.objectType === e;
		}),
		(f.OptionalCallExpression = f.OptionalMemberExpression =
			function (e, t) {
				return (So(t) && t.callee === e) || (vo(t) && t.object === e);
			}),
		(f.SequenceExpression = function (e, t) {
			...
			return (
				"ClassDeclaration" === n ||
				("ForOfStatement" !== n
					? "ExportDefaultDeclaration" === n || !Ao(t)
					: t.right === e)
			);
		}),
		...
		(f.UnaryLike = f.TSTypeAssertion = jo),
	...
	var mo = t;
	let {
			isArrayTypeAnnotation: To,
			isBinaryExpression: ho,
			isCallExpression: So,
			isForOfStatement: bo,
			isIndexedAccessType: Eo,
			isMemberExpression: vo,
			isObjectPattern: go,
			isOptionalMemberExpression: Po,
			isYieldExpression: xo,
			isStatement: Ao
		} = e,
		Oo = new Map([
			["||", 0],
	...
	function No(e) {
		return Boolean(e & (mo.TokenContext.expressionStatement | mo.TokenContext.arrowBody));
	}
	function wo(e, t) {
		var n = t.type;
		if (
			...
			return t.left === e;
		if (Co(e, t)) return !0;
		if (Do(e, t) || "UnaryExpression" === n || "SpreadElement" === n || "AwaitExpression" === n)
			return !0;
		var r = _o(t, n);
		if (null != r) {
			var i = _o(e, e.type);
	...
	function jo(e, t) {
		return Do(e, t) || (ho(t) && "**" === t.operator && t.left === e) || Co(e, t);
	}
	function ko(e, t) {
		var n = t.type;
		return (
	...
	Object.defineProperty(t, "__esModule", { value: !0 }),
		...
		(t.needsParens = function (e, t, n, r, i) {
			var a;
			if (!t) return !1;
			if (
				Xo(t) &&
				...
				(function e(t) {
					if (Ko(t)) return !0;
					return Jo(t) && e(t.object);
				})(e)
			)
				return !0;
			if (Yo(t)) return !(Ho(e) || (Ko(e) && Ho(e.callee)) || qo(e));
			return null == (a = Wo.get(e.type)) ? void 0 : a(e, t, n, r, i);
		}),
		(t.needsWhitespace = zo),
	...
	let Lo = r,
		...
		Bo = e,
		{
			FLIPPED_ALIAS_KEYS: Fo,
			VISITOR_KEYS: Ro,
			isCallExpression: Ko,
			isDecorator: Yo,
			isExpressionStatement: Vo,
			isMemberExpression: Jo,
			isNewExpression: Xo,
			isParenthesizedExpression: qo
		} = Bo;
	function Uo(e) {
		let t = new Map();
		function n(e, o) {
	...
	function zo(e, t, n) {
		if (!e) return !1;
		Vo(e) && (e = e.expression);
		var r = null == (r = Go.get(e.type)) ? void 0 : r(e, t);
	...
	function Ho(e) {
		switch (e.type) {
			case "Identifier":
				return !0;
			case "MemberExpression":
				return !e.computed && "Identifier" === e.property.type && Ho(e.object);
			default:
				return !1;
		}
	}
	let $o = {},
		Qo = (Object.defineProperty($o, "__esModule", { value: !0 }), ($o.TokenMap = void 0), e),
		{ traverseFast: Zo, VISITOR_KEYS: es } = Qo;
	class ts {
		constructor(e, t, n) {
			(this._tokens = void 0),
				(this._source = void 0),
	...
	($o.TokenMap = ts),
		...
		(y.AssignmentPattern = function (e) {
			this.print(e.left),
				("Identifier" !== e.left.type && !ss(e.left)) ||
		...
		(y.ExpressionStatement = function (e) {
			(this.tokenContext |= ns.TokenContext.expressionStatement),
		...
		(y.MemberExpression = function (e) {
			if ((this.print(e.object), !e.computed && as(e.property)))
				throw new TypeError("Got a MemberExpression for MemberExpression property");
			let t = e.computed;
			is(e.property) && "number" == typeof e.property.value && (t = !0);
			{
				var n;
				t
		...
		(y.OptionalMemberExpression = function (e) {
			...
			if ((this.print(e.object), !t && as(r)))
				throw new TypeError("Got a MemberExpression for MemberExpression property");
			is(r) && "number" == typeof r.value && (t = !0);
			n && this.token("?.");
			t
	...
	(l = {}),
		...
		(l.BreakStatement = function (e) {
			this.word("break"), ys(this, e.label);
		}),
		...
		(l.ContinueStatement = function (e) {
			this.word("continue"), ys(this, e.label);
		}),
		(l.DebuggerStatement = function () {
		...
		(l.ForStatement = function (e) {
			this.word("for"), this.space(), this.tokenChar(40);
			{
				...
				(this.tokenContext |= ls.TokenContext.forHead), this.print(e.init), t();
			}
		...
		(l.ReturnStatement = function (e) {
			this.word("return"), ys(this, e.argument);
		}),
		...
		(l.ThrowStatement = function (e) {
			this.word("throw"), ys(this, e.argument);
		}),
		...
		(l.VariableDeclaration = function (e, t) {
			...
			this.space();
			let r = !1;
			if (!ps(t)) for (var i of e.declarations) i.init && (r = !0);
			if (
				(this.printList(
					e.declarations,
					void 0,
	...
	var ls = t;
	let { isFor: ps, isForStatement: us, isIfStatement: cs, isStatement: ds } = e;
	function fs(e) {
		...
		(this.tokenContext |= t ? ls.TokenContext.forOfHead : ls.TokenContext.forInHead),
			this.print(e.left),
			null != n && n(),
			this.space(),
			this.word(t ? "of" : "in"),
	...
	let { isExportDefaultDeclaration: ms, isExportNamedDeclaration: Ts } = e;
	(s = {}),
		...
		(s.ArrowFunctionExpression = function (e, t) {
			...
			this._predicate(e, !0),
				...
				this.token("=>"),
				this.space(),
				(this.tokenContext |= hs.TokenContext.arrowBody),
				this.print(e.body);
		}),
	...
	(c = {}),
		...
		(c.ExportDefaultDeclaration = function (e) {
			_s(this, e),
				...
				this.word("default"),
				this.space(),
				(this.tokenContext |= bs.TokenContext.exportDefault);
			e = e.declaration;
			this.print(e), As(e) || this.semicolon();
		}),
		(c.ExportDefaultSpecifier = function (e) {
			this.print(e.exported);
		}),
		(c.ExportNamedDeclaration = function (i) {
			if ((_s(this, i), this.word("export"), this.space(), i.declaration)) {
				var e = i.declaration;
				this.print(e), As(e) || this.semicolon();
			} else {
	...
	let {
			...
			isExportDefaultSpecifier: vs,
			isExportNamespaceSpecifier: gs,
			isImportDefaultSpecifier: Ps,
			isImportNamespaceSpecifier: xs,
			isStatement: As
		} = e,
		Os = !1;
	function _s(e, t) {
	...
	I = {};
	let Is = (Jn = {}).hasOwnProperty,
		Cs = (e, t) => {
			for (var n in e) Is.call(e, n) && t(n, e[n]);
		},
		Ds = e => "\\u" + ("0000" + e).slice(-4),
		Ns = (e, t) => {
			e = e.toString(16);
		...
		Ys = (n, l) => {
			...
			if (
				...
				"string" != typeof (b = n) && "[object String]" != ws.call(b))
			) {
				if (((b = n), "[object Map]" == ws.call(b)))
					return 0 == n.size
						? "new Map()"
						: (i || ((l.__inline1__ = !0), (l.__inline2__ = !1)),
							"new Map(" + Ys(Array.from(n), l) + ")");
				if (((b = n), "[object Set]" == ws.call(b)))
					return 0 == n.size ? "new Set()" : "new Set(" + Ys(Array.from(n), l) + ")";
				if (((b = n), "function" == typeof Buffer && Buffer.isBuffer(b)))
					return 0 == n.length
						? "Buffer.from([])"
						: "Buffer.from(" + Ys(Array.from(n), l) + ")";
				if (js(n))
					return (
						(f = []),
						(l.wrap = !0),
				...
				if ("number" == typeof (b = n) || "[object Number]" == ws.call(b) || ks(n)) {
			...
			var b = l.escapeEverything ? Rs : Ks;
			return (
						...
						? l.minimal
							...
							: ((o = t.charCodeAt(0)),
								...
								l.es6
									...
									: Ds(Ns(o, c)) + Ds(Ns(t, c)))
						: n
							? Ds(Ns(n.charCodeAt(0), c))
							: "\0" != e || p || Bs.test(a.charAt(i + 1))
								? r
	...
	(Ys.version = "3.0.2"),
		...
		(I.ObjectProperty = function (e) {
			if ((this.printJoin(e.decorators), e.computed))
				...
				if (Js(e.value) && Xs(e.key) && e.key.name === e.value.left.name)
					return void this.print(e.value);
				if (
					(this.print(e.key),
					e.shorthand && Xs(e.key) && Xs(e.value) && e.key.name === e.value.name)
				)
					return;
			}
		...
		(I.StringLiteral = function (e) {
			...
			this.format.minified || void 0 === t
				? ((e = Vs(e.value, this.format.jsescOption)), this.token(e))
				: this.token(t);
		}),
		(I.TopicReference = function () {
			var e = this.format.topicToken;
			{
				...
				if (!Ws.has(e))
					throw (
						((t = JSON.stringify(e)),
						(n = Array.from(Ws, e => JSON.stringify(e))),
						new Error(
		...
		(I._getRawIdentifier = function (e) {
			...
			if (n) return (Us = this._originalCode.slice(n.start, n.end));
			return (Us = e.name);
		});
	var Vs = qn;
	let { isAssignmentPattern: Js, isIdentifier: Xs } = e,
		qs = null,
		Us = "",
		Ws = new Set(["^^", "@@", "^", "%", "#"]);
	Wn = {};
	{
		(C = Wn),
			...
			(C.DeclareExportAllDeclaration = function (e) {
				this.word("declare"), this.space(), Gs.ExportAllDeclaration.call(this, e);
			}),
			...
			(C.IntersectionTypeAnnotation = function (e) {
				this.printJoin(e.types, void 0, void 0, el);
			}),
			...
			(C.TypeAnnotation = function (e, t) {
				this.tokenChar(58),
					...
					"ArrowFunctionExpression" === t.type
						? (this.tokenContext |= zs.TokenContext.arrowFlowReturnType)
						: e.optional && this.tokenChar(63);
				this.print(e.typeAnnotation);
			}),
	...
	(zn = {}),
		...
		(zn.Directive = function (e) {
			this.print(e.value), this.semicolon();
		}),
		(zn.DirectiveLiteral = function (e) {
			var t = this.getPossibleRaw(e);
		...
		(zn.InterpreterDirective = function (e) {
			this.token("#!" + e.value), this.newline(1, !0);
		}),
		(zn.Placeholder = function (e) {
			this.token("%%"),
				this.print(e.name),
				this.token("%%"),
				"Statement" === e.expectedNode && this.semicolon();
		}),
		(zn.Program = function (e) {
		...
		(D.JSXOpeningElement = function (e) {
			...
			this.print(e.typeParameters),
				0 < e.attributes.length &&
					(this.space(), this.printJoin(e.attributes, void 0, void 0, il));
	...
	Object.defineProperty(N, "__esModule", { value: !0 }),
		...
		(N.TSCallSignatureDeclaration = function (e) {
			this.tsPrintSignatureDeclarationBase(e), Tl(this, e);
		}),
		...
		(N.TSConstructSignatureDeclaration = function (e) {
			this.word("new"), this.space(), this.tsPrintSignatureDeclarationBase(e), Tl(this, e);
		}),
		...
		(N.TSEnumDeclaration = function (e) {
			...
			this.word("enum"), this.space(), this.print(r), this.space(), bl.call(this, e);
		}),
		...
		(N.TSInterfaceBody = function (e) {
			El(this, e, () => this.printJoin(e.body, !0, !0));
		}),
		...
		(N.TSMappedType = function (e) {
			...
			this.space(), r && (Sl(this, r), this.word("readonly"), this.space());
			this.tokenChar(91),
			...
			this.tokenChar(93), n && (Sl(this, n), this.tokenChar(63));
		...
		(N.TSModuleBlock = function (e) {
			El(this, e, () => this.printSequence(e.body, !0));
		}),
		...
		(N.TSPropertySignature = function (e) {
			var t = e.readonly;
			t && (this.word("readonly"), this.space());
			this.tsPrintPropertyOrMethodName(e), this.print(e.typeAnnotation), Tl(this, e);
		}),
		...
		(N.TSTypeLiteral = function (e) {
			El(this, e, () => this.printJoin(e.members, !0, !0));
		}),
		...
		(N.tsPrintClassMemberModifiers = function (e) {
			...
			vl(this, e, [n && e.declare && "declare", !t && e.accessibility]),
				e.static && (this.word("static"), this.space());
			vl(this, e, [
		...
		(er = {}),
		Object.defineProperty(er, "__esModule", { value: !0 }),
		(er.addDeprecatedGenerators = function (e) {
	...
	let {
		...
		kl = /[\n\r\u2028\u2029]|\*\//;
	function Ll(e) {
		return "CommentLine" === e.type || jl.test(e.value);
	}
	let Ml = Pl.needsParens;
	class Bl {
		constructor(e, t, n, r) {
			(this.inForStatementInit = !1),
				...
				(this._buf = new gl.default(t, e.indent.style[0]));
		}
		...
		generate(e) {
			return (
				this.format.preserveFormat &&
					(this.tokenMap = new xl.TokenMap(e, this._tokens, this._originalCode)),
				this.print(e),
		...
		print(a, o, s) {
			if (a) {
				...
				!e &&
					...
					((null != (y = a.leadingComments) && y.some(Ll)) ||
				...
				e ||
					((o =
						o ||
						(d && this._noLineTerminatorAfterNode === d && Pl.isLastChild(d, a))) &&
						(null != (i = a.trailingComments) && i.some(Ll)
							? Al(a) && (e = !0)
		...
		printList(e, t, n, r, i, a) {
			this.printJoin(e, n, r, null != i ? i : Fl, t, void 0, a);
		}
		...
		_shouldPrintComment(t, e) {
			...
			if (this._noLineTerminator && kl.test(t.value)) return 2;
			if (e && this.tokenMap) {
...
` + " ".repeat(e)
	...
	Object.assign(Bl.prototype, p),
		(0, tr.addDeprecatedGenerators)(Bl),
		(K.default = Bl),
	...
	function Vl(e, t = {}, n) {
		var r = Yl(n, t, e),
			t = t.sourceMaps ? new Rl.default(t, n) : null;
		return new Kl.default(r, t, e.tokens, "string" == typeof n ? n : null).generate(e);
	}
	(M.CodeGenerator = class {
		constructor(e, t = {}, n) {
			(this._ast = void 0),
				(this._format = void 0),
				(this._map = void 0),
				(this._ast = e),
				(this._format = Yl(n, t, e)),
				(this._map = t.sourceMaps ? new Rl.default(t, n) : null);
		}
		generate() {
			return new Kl.default(this._format, this._map).generate(this._ast);
		}
	}),
		(window.Babel.generator = Vl),
		Babel.registerPlugin(
			...
			({
				...
				let p = e => {
					e = Vl(e).code;
					let t = e.replace(/\?\./g, ".").match(/[^\.\[\]]+|\[[^\]]+\]/g) || [];
					e = (t = t.map(e => {
						var t = e.match(/\[([^\]]+)\]/);
						return t ? ((t = t[1]), /^\d+$/.test(t) ? t : ["${", t, "}"].join("")) : e;
					})).shift();
					let r = t.join(".");
					try {
						if (r.includes("${")) {
						...
						(r = n(r)), console.error(e);
					}
					return { FIRST_OBJ: e, CHAIN_PATH: r };
				};
				return {
					visitor: {
						OptionalMemberExpression(e) {
							var { FIRST_OBJ: t, CHAIN_PATH: n } = p(e.node),
								t =
									(console.log("OptionalMemberExpression", n),
									r(i(o("_"), o("$val")), [o(t), n]));
							e.replaceWith(t);
						},
						OptionalCallExpression(e) {
							...
							var t,
								n = e.node.callee;
							a(n) &&
								(({ FIRST_OBJ: n, CHAIN_PATH: t } = p(n)),
								(n = r(
									r(i(o("_"), o("$callFn")), [o(n), t]),
									e.node.arguments || []
								)),
								e.replaceWith(n));
						}
		...
		(window.Babel.babelTransformCode = function (e) {
			try {
				var t = Babel.transform(e, { plugins: ["custom-plugin"] }).code;
				e = t;
			} catch (e) {
				console.error(e);
			}
