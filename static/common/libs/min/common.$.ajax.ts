_.$ajax = (() => {
	let l = e =>
		...
		r = {
			urlWrapper: c,
			upload: ({ method: t, url: o, formData: n, callback: a, headers: s }) => (
				(t = t || "post"),
				(a = a || (() => null)),
				new Promise((e, r) => {
			...
			post: (t, o = {}) =>
				new Promise((e, r) => {
					$.ajax(l({ type: "POST", options: o, url: t, success: e, error: r }));
				}),
			get: (t, o = {}) =>
				new Promise((e, r) => {
					$.ajax(
						l({ type: "GET", url: t, options: o, timeout: 6e4, success: e, error: r })
					);
				}),
			put: (t, o = {}) =>
				new Promise((e, r) => {
					$.ajax(l({ type: "put", url: t, options: o, success: e, error: r }));
				}),
			delete: (t, o = {}) =>
				new Promise((e, r) => {
					$.ajax(l({ type: "delete", url: t, options: o, success: e, error: r }));
				})
		};
	return r;
})();
