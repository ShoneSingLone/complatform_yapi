...
export default async function () {
	 ...
	 * @return
	 */
	function onAfterCopy({ event, selectionRangeData }) {
	 ...
	 * @return
	 */
	function onBeforePaste({ event, cellSelectionRangeData, colgroups, allRowKeys }) {
		let pastedData;
	 ...
	 * @return
	 */
	function onAfterPaste({ tableData, beforePasteResponse }) {
	 ...
	 * @return {selectionRangeIndexes,selectionRangeKeys,data}
	 */
	function onBeforeCut({ cellSelectionRangeData, selectionRangeData, colgroups, allRowKeys }) {
		const { leftColKey, rightColKey, topRowKey, bottomRowKey } = cellSelectionRangeData;
	 ...
	 * @return
	 */
	function onAfterDelete({ tableData, colgroups, selectionRangeIndexes }) {
		const { endColIndex, endRowIndex, startColIndex, startRowIndex } = selectionRangeIndexes;
