...
export default async function () {
	// prefix
	const PREFIX_CLS = "ve-table-";

	// locale comp name
	const LOCALE_COMP_NAME = "table";
	...
	// column fixed type
	const COLUMN_FIXED_TYPE = {
		LEFT: "left",
		RIGHT: "right"
	};

	// expand row trigger types
	const EXPAND_TRIGGER_TYPES = {
	...
	const CELL_SELECTION_DIRECTION = {
		UP: "up",
		RIGHT: "right",
		DOWN: "down",
		LEFT: "left"
	...
	const CURRENT_CELL_SELECTION_TYPES = {
		SINGLE: "single",
		RANGE: "range"
	};
