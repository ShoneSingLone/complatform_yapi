...
export default async function () {
	return defineComponent({
		components: {
			...
			RtcRecordVideo: () =>
				_.$importVue("@/views/Rtc/RtcComponents/RtcRecordVideo.vue"),
			RtcRecordScreen: () =>
				_.$importVue("@/views/Rtc/RtcComponents/RtcRecordScreen.vue"),
			RtcRecordAudio: () =>
				_.$importVue("@/views/Rtc/RtcComponents/RtcRecordAudio.vue"),
			RtcCaptureCanvas: () =>
			...
			RtcMicrophone: () =>
				_.$importVue("@/views/Rtc/RtcComponents/RtcMicrophone.vue")
		},
		provide() {
			return {
				inject_rtc: this
		...
		methods: {
			...
			broadcastChildren(eventName, payload) {
				["RtcMicrophone", "RtcCamera", "RtcMediaStreamAPI"].forEach(
					componentName => {
