<template>
	<div class="avatar-uploader flex middle xspaceItemAvatar" v-bind="$attrs">
		<xIcon
			:img="cptAvatarUrl"
			iscache="true"
...
export default async function () {
	...
	return {
		componentName: "xspaceItemAvatar",
		inject: ["APP"],
		mixins: [mixins],
		...
		methods: {
			syncAllItem(imageUrl) {
				this.$root.broadcast("xspaceItemAvatar", "updateAvatar", {
					uid: this.value,
					imageUrl
				});
			},
...
.xspaceItemAvatar {
	...
	.xItem-wrapper[data-form-item-type="xspaceItemAvatar"] {
