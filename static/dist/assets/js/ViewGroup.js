import { d as defineComponent, s as stateApp, c as cptRouter, e as xU, f as createVNode, r as resolveComponent, F as Fragment, v as ADMIN, x as xI$1, t as createTextVNode, a as defItem, b as API, U as components, g as isVNode, O as OWNER, w as withDirectives, j as resolveDirective, i as itemsInvalid, an as ErrMsg, q as PRIVATE, ao as index, ap as defPagination, aq as METHOD_COLOR, ar as LOG_TYPE, as as _$timeAgo, at as jsondiffpatch, C as _export_sfc, E as openBlock, H as createElementBlock, I as withCtx, J as renderList, au as reactive, W as defDataGridOption, aj as onMounted, D as DEV, R as defCol, av as TAB_KEY_PROJECT_LIST, aw as TAB_KEY_MEMBER_LIST, u as PUBLIC, ax as TAB_KEY_GROUP_LOG, ay as TAB_KEY_GROUP_WIKI, G as GROUP, K as aHashLink, az as OPEN_BLANK } from "./index.js";
    ...
    return {
      ...
      formItems: {
        ...
        custom_field1_name: defItem({
          ...
          label: xI$1("\u63A5\u53E3\u81EA\u5B9A\u4E49\u5B57\u6BB5"),
          labelVNodeRender: VNodeCollection.labelTips(createVNode("div", null, [xI$1("\u53EF\u4EE5\u5728\u63A5\u53E3\u4E2D\u6DFB\u52A0 \u989D\u5916\u5B57\u6BB5 \u6570\u636E")])),
          placeholder: xI$1("\u989D\u5916\u5B57\u6BB5"),
          rules: [FormRules.required()],
          once() {
    ...
    showDeleteGroupConfirm() {
      ...
      xU.confirm({
        ...
        content: () => createVNode(Fragment, null, [createVNode(resolveComponent("ElAlert"), {
          "title": xI$1("\u8B66\u544A\uFF1A\u6B64\u64CD\u4F5C\u975E\u5E38\u5371\u9669,\u4F1A\u5220\u9664\u8BE5\u5206\u7EC4\u4E0B\u9762\u6240\u6709\u9879\u76EE\u548C\u63A5\u53E3\uFF0C\u5E76\u4E14\u65E0\u6CD5\u6062\u590D!").label,
          "type": "warning"
...
function fnShowUpsertGroupDialog(row = {}) {
  ...
  xU.dialog({
    title: isUpdate ? xI$1("\u4FEE\u6539\u5206\u7EC4\u4FE1\u606F") : xI$1("\u6DFB\u52A0\u5206\u7EC4"),
  ...
  computed: {
    vDomAddProjectButton() {
      const btnConfigs = {
        text: xI$1("\u6DFB\u52A0\u9879\u76EE"),
        type: "primary",
        disabled: this.isAuthAddProject ? "" : `<div>${xI$1("\u60A8\u6CA1\u6709\u6743\u9650")}</div>
					<div>${xI$1("\u8BF7\u8054\u7CFB\u8BE5\u5206\u7EC4\u7EC4\u957F\u6216\u7BA1\u7406\u5458")}</div>`,
    ...
    vDomNoFollowPanel() {
      ...
      if (xU.isArrayFill(unfollowArray)) {
        return createVNode("div", {
          ...
          "class": "owner-type"
        }, [xI$1("\u6211\u7684\u9879\u76EE")]), this.genProjectCard(unfollowArray, this.isAuthAddProject)]);
      }
      return null;
    },
    vDomFollowPanel() {
      ...
      if (xU.isArrayFill(followProject)) {
        return createVNode("div", {
          ...
          "class": "owner-type"
        }, [xI$1("\u6211\u7684\u5173\u6CE8")]), this.genProjectCard(followProject)]);
      } else {
        return null;
      }
    },
  ...
  setup() {
    return function() {
      return createVNode(Fragment, null, [createVNode("section", {
        "class": "mb10 mt10 el-card padding20"
      ...
      if (this.type === "project") {
        return createVNode(resolveComponent("ElRow"), {
          ...
          default: () => [createVNode(resolveComponent("ElCol"), {
            ...
            default: () => [xI$1("\u9009\u62E9\u67E5\u8BE2\u7684 Api"), createTextVNode("\uFF1A")]
          }), createVNode(resolveComponent("ElCol"), {
            "span": "10"
          }, {
  ...
  setup() {
    ...
    const methods = {
      async initTableColumns() {
        ...
        state2.configs_table.columns = {
          ...defCol({
            prop: "name",
            label: `\u6210\u5458 ${state2.configs_table.dataSource.length} \u4EBA`,
            renderCell({
              record
            }) {
      ...
      async fetchGroupMemberList() {
        const menber = await stateApp._fetchGroupMemberList(stateApp.currGroup._id);
        state2.userInfo = arrayAddKey(menber);
      },
      async addMember({
        member_uids,
        role
    ...
    return function() {
      return createVNode(Fragment, null, [state2.configs_table.dataSource.length, createVNode(resolveComponent("xDataGrid"), {
        "configs": state2.configs_table
      }, null)]);
    };
  },
  watch: {
    userInfo() {
      ...
      if ((_a = state.configs_table.columns) == null ? void 0 : _a.name) {
  ...
  computed: {
    ...
    vDomTabMember() {
      ...
      if (this.stateApp.currGroup.type === PUBLIC) {
        return createVNode(GroupMemberList, null, null);
      } else {
        return null;
      }
    },
    ...
    vDomSwitchPanel() {
      ...
      return createVNode("div", {
        ...
        if (name === TAB_KEY_GROUP_WIKI) {
          ...
          const tipsLabel = xI$1(OPEN_BLANK);
          tips = {
