    ...
    return function() {
      var __webpack_modules__ = { 4264: function(t, n, e) {
        ...
        function m2(t2) {
          if (null == t2)
            return s;
          for (var n2 = arguments.length, e2 = new Array(n2 > 1 ? n2 - 1 : 0), o = 1; o < n2; o++)
            e2[o - 1] = arguments[o];
        ...
        function E(t2, n2, e2, o) {
          if (t2[2] && o) {
            ...
            if (void 0 === n2.dirty)
              return r;
            if ("object" == typeof r) {
              for (var i2 = [], a = Math.max(n2.dirty.length, r.length), c = 0; c < a; c += 1)
                i2[c] = n2.dirty[c] | r[c];
              return i2;
            }
            return n2.dirty | r;
        ...
        function T(t2) {
          if (t2.ctx.length > 32) {
            for (var n2 = [], e2 = t2.ctx.length / 32, o = 0; o < e2; o++)
              n2[o] = -1;
            return n2;
          }
          return -1;
        ...
        function bt(t2, n2, e2, o, r, i2, a, c, u, s2, l2, f2) {
          for (var d2 = t2.length, v2 = i2.length, p2 = d2, h2 = {}; p2--; )
            h2[t2[p2].key] = p2;
...
const vconsole_min = /* @__PURE__ */ getDefaultExportFromCjs(vconsole_min$2.exports);
const vconsole_min$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: vconsole_min
}, [vconsole_min$2.exports]);
export {
  vconsole_min$1 as v
};
