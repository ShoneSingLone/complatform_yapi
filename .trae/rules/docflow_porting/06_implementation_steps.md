   ...
   <template>
     <div class="docflow-editor">
       <div class="editor-toolbar">
         ...
         <button 
           @click="editor.chain().focus().setNode('heading', { level: 1 }).run()"
         >
           H1
         </button>
         <button 
           @click="editor.chain().focus().setNode('heading', { level: 2 }).run()"
         >
           H2
         </button>
         <button 
...
通过以上实施步骤，我们将成功将 DocFlow 的核心功能移植到 business_yapi 项目中，为用户提供更加现代化、高效的文档编辑与协作体验。