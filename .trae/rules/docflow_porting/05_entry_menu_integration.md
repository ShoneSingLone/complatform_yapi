...
<template>
	<div class="docflow-editor-page">
		...
		<div class="editor-container">
			<DocFlowEditor ref="editor" :initial-content="document.content" @update:content="handleContentUpdate" />
		</div>
...
export default async function ({ PRIVATE_GLOBAL }) {
	// 动态加载 DocFlow 编辑器组件
	const [DocFlowEditor] = await _.$importVue(["@/components/DocFlow/Editor.vue"]);
