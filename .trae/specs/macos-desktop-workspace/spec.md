...
| 2026-04-04 | v1.1 | -      | 明确入口文件路径和路由配置：入口文件 `/Users/shone/workspace/xspace_xspace/static/business_xspace/views/v1/ViewXspace.vue`，路由路径 `/v1` |
...
为 business_xspace 项目 v1 版本打造一个仿 macOS 风格的桌面工作空间应用，将复杂的 API 管理系统抽象为"资源管理器（File
Explorer）"模式。
...
-   **同类窗口堆叠**：同类型资源（Group/Project/API/Doc 等）窗口自动堆叠在同一图标下
...
-   **主入口文件**：`/Users/shone/workspace/xspace_xspace/static/business_xspace/views/v1/ViewXspace.vue`
